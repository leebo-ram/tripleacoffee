...
window.addEventListener('click', (e) => {
    ...
    // 해제 btn
    if (e.target.closest('div')) {
        if (e.target.closest('div').className == 'order__menu__cancel__btn') {
            console.log(e.target.closest('div').childNodes);

            console.log(e.target.closest('div').firstElementChild.value);
            const target = document.getElementById(
                `${e.target.closest('div').firstElementChild.value}`
            );
            console.log(target);
            //     target.value++;
            //     return;
            // } else if (
            //     e.target.closest('div').className == 'showMenu__minus__btn'
            // ) {
            //     console.log('-');
            //     const target = document.getElementById(
            //         `${e.target.closest('div').firstElementChild.value}`
