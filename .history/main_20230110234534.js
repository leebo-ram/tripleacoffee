    ...
    if (e.target.closest('div')) {
        if (e.target.closest('div').classList.contains('order__menu')) {
            ...
            if (e.target.closest('div').classList.contains('order__menuBtns')) {
                ...
                const replaceFontColor = document.querySelector('.order__menu__name.decoration')
                if (active != null) {
                    active.classList.remove('selected');
                }else if (e.target.closest('p').classList.contains('order__menu__name.decoration')){
                    if(replaceFontColor != null) {
                        replaceFontColor.classList.remove('decoration')
                    }
                }
