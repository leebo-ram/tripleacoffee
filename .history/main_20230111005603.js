...
const see = document.getElementById('orderList_box').getElementsByClassName('order__menu__btn');
// document.getElementsByClassName('order__menu__btn');
const parent = see.parentNode;
console.log(parent);