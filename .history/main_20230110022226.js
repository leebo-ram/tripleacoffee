...
window.addEventListener('click', (e) => {
    ...
    // 베이스 레시피1
    // if (e.target.closest('div')) {
    //     if (e.target.closest('div').classList.contains('base__recipe1')) {
    //         const active = document.querySelector('.base__recipe1.selected');
    //         if (active != null) {
    //             active.classList.remove('selected');
    //         } else {
    //             e.target.closest('div').classList.add('selected');
    ...
    // 베이스 레시피2
    // if (e.target.closest('div')) {
    //     if (e.target.closest('div').classList.contains('base__recipe2')) {
    //         const active = document.querySelector('.base__recipe2.selected');
    //         if (active != null) {
    //             active.classList.remove('selected');
    //         } else {
    //             e.target.closest('div').classList.add('selected');
    ...
    if (e.target.closest('div')) {
        if (
            e.target.closest('div').classList.contains('base__recipe1') ||
            e.target.closest('div').classList.contains('base__recipe2')
        ) {
            const active1 = document.querySelector('.base__recipe1.selected');
            const active2 = document.querySelector('.base__recipe2.selected');
            if (active1 != null) {
                active1.classList.remove('selected');
