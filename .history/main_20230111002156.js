...
window.addEventListener('click', (e) => {
    ...
    if (e.target.closest('div')) {
        ...
        if (e.target.closest('div')) {
            ...
            if (e.target.closest('div')) {
                if (e.target.closest('div').classList.contains('order__menu__name')) {
                    const active = document.querySelector('.order__menu__name.deco');
                    if (active != null) {
                        active.classList.remove('deco');
                    }
                    if (!e.target.closest('div').classList.contains('deco')) {
                        e.target.closest('div').classList.add('deco');
                    }
                    return;
                }
            }
