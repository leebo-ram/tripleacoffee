...
window.addEventListener('click', (e) => {
  ...
  // 전체 삭제 부분
    ...
    const target = document.getElementById(`${e.target.closest('button').firstElementChild.value}`);
    console.log(target);
    target.value = `${target.value}${num_array[]}`
  }
