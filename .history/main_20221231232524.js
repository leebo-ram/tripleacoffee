...
const seclet_opstions = document.querySelector('.option__discription');
seclet_opstions.addEventListener('click', (e) => {
  const active = document.querySelector('.option__discription.selected');
    if (active != null) {
      active.classList.remove('selected');
    }
    e.target.classList.add('selected');
