import json_import from "../dummy.json" assert { type: "json" };
            ...
            <h3>
              ...
              ${this.state.data.map(item => `
                <div class="order__menu">
                  <p class="order__menu__name">${item.orderList.name} <span>${item.orderList.quantity}</span></p>
