            ...
            <h3>
              ...
              ${this.state.data.map(item => `
                <div class="order__menu">
                  <p class="order__menu__name">${item.orderList[i].name} <span>${item.orderList[i].quantity}</span></p>
                  <ul class="order__menu__option">
                  <li>
                  ▶ ${item.orderList[i].options} 
                  <!-- <span>${item.orderList[i].options} </span> -->
                </li>
                <li>▶ ${item.orderList[i].options}  <span>1</span></li>
                <li>▶ ${item.orderList[i].options}  <span>1</span></li>
              </ul>
